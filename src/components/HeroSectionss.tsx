...
import heroImage from "@/assets/Hero-Sectionss.jpeg";

export default function HeroSectionss() {
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
        ...
        Moments of Grace and Expression
        ...
        A visual journey through performances, cultural celebrations, student achievements, and the timeless beauty of Bharatanatyam.
